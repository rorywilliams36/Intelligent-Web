...
function generateRoom() {
    console.log('Running generateRoom  ')
...
function sendChatText() {
    ...
    console.log('Msg', chatText, 'to', roomNo, 'from', username)
    socket.emit('chat', roomNo, username, chatText);
}

/**
 * used to connect to a room. It gets the user username and room number from the
 * interface
 */
 ...
 * @param userId the user username
 */
